...
def calibrate_pixels_per_cm():
    """ Calibrate the pixels per cm using a reference object """
    ...
    ref_width_cm = get_user_input("Enter the width of the reference object in cm: ")
...
def process_frame(frame, PIXELS_PER_CM, MIN_SIZE, MAX_SIZE):
...
def main():
    ...
    while True:
        ...
        frame = process_frame(frame, PIXELS_PER_CM, MIN_SIZE, MAX_SIZE)
